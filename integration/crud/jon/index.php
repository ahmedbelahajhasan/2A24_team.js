<?php
     $con = new mysqli ('localhost', 'root', '', 'store_db' );
  if($con){
  //  echo "connected";
  }
?>
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Statistics of prices compared to prencentage of offers'
        };
               ...
               <div class="row">
                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                    <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div c lass="collapse navbar-collapse" id="navbarsExample04">
