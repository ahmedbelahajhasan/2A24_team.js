...
if(isset($_POST['submit'])){
   $nom=$_POST['nom'];
    ...
    $sql="update `reclamations` set id=$id,nom='$nom',email='$email' ,numtel='$numtel',reclamation='$reclamation' where id=$id";
...
<div class="mb-3">
  ...
  <button class="btn btn-warning" type="submit" class="btn btn-primary" name="submit">edit</button>
</form>
</div>
  </body>
</html>