...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `reclamations` WHERE CONCAT(`nom`, `email`, `numtel`, `reclamation`) LIKE '%".$valueToSearch."%'";
...
<button class="nodeco botSender" onclick="botReply(this.value)" value="1" id="StoreLocator">How to add a claim ? </button>
<button class="nodeco botSender" onclick="botReply(this.value)" value="2" id="Products">How to edit a claim ?</button>
<button class="nodeco botSender" onclick="botReply(this.value)" value="3" id="EventPublish">How to delete a claim ?</button>
...
var text = document.createTextNode("Click on add a claim and complete the form correctly.");
message.appendChild(text);
...
var text = document.createTextNode("click on modify and change the data. ");
message.appendChild(text);
...
var text = document.createTextNode("Just click on delete in front of the claim.");
message.appendChild(text);
...
element.appendChild(containe);
  ...
  <script>
      ...
      <button class="btn btn-danger my-5"><a href="../../Ecommerce-master/template/index.php"
              class="text-light">Home</a>
      <div class="container">
          <button class="btn btn-warning my-5"><a href="user.php"
              class="text-light">add a claim</a>
</button>
...
<table class="table table-warning table-striped">
  <thead>
    ...
    <body>
    <?php $sql="Select * from `reclamations`";
...
{  $id=$row['id'];} while($row = mysqli_fetch_array($search_result)):?>
                ...
                <td><?php echo $row['id'];?></td>
                    ...
                    <td><?php echo '
        <button class="btn btn-warning"><a href="modifier.php?modifierid='.$id.'" class="text-light">edit</a></button>
        <button class="btn btn-danger"><a href="supprimer.php?supprimerid='.$id.'" class="text-light">delete</a></button>
    ';?></td>
