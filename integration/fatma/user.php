...
if(isset($_POST['submit'])){
    ...
    $sql="insert into `reservation`(id_res,id_user,prix,des)
...
"https://chart.googleapis.com/chart?cht=qr&chl=Hello+World&chs=160x160&chld=L|0"
	...
	<div class="form-horizontal" style="margin-left: 380px;">
...
<html lang="en">
  ...
  <body>
    ...
    <form method="post">
    <div style="width:25%;" class="mb-3">
        <label >id reservation</label>
        <input class="form-control"
        placeholder="enter your id reservation" id="id_res" name="id_res" style="background-color: #FF6600" >
        <span id="cidres"></span>
    ...
    <div style="width:25%;" class="mb-3">
        ...
        placeholder="entrer your id user"  id="ml" name="id_user" size="10" style="background-color: #FF6600" >
    ...
    <div style="width:25%;" class="mb-3">
        ...
        placeholder="enter price " id="number"  name="prix" style="background-color: #FF6600">
    ...
    <div style="width:25%;" class="mb-3">
        ...
        <input class="form-control"
        placeholder="enter your description" id="description" name="des" style="background-color: #FF6600">
    ...
    <button type="button" class="btn btn-sm btn-outline-secondary" onclick=" window.print();" style="background: rgb(227, 172, 4);">Export</button>
