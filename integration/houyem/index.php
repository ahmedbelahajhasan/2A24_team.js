  ...
  <div class="wrapper">
    ...
    <div class="nav">
      ...
      <div class="menu-links menu ul li:hover">
        <ul>
          <li ><a href="http://localhost/houyem/index.php" class ="no-underline textBlack">home</a></li>
    ...
    <div class="watchnow ">
      ...
      <a href="http://localhost/houyem/index.php" class =" no-underline textBlack" >welcome</a>
    </div>
