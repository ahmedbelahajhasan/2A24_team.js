<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            $sql = "insert into `partenaire` (nom, prenom, adresse, email, description) values('$nom', '$prenom', '$adresse', '$email', '$description')";
    ...
    body
{
    ...
    <title>Add the partner</title>
  </head>
  <h1 class="px-76 py-26 font-lato text-white" style="margin-left: 41px;margin-top: 32px;" >Add the partner</h1>
  ...
  <body class ="bg-brown" style="margin-right: 139px;">
    ...
    <div class="alert hide">
         ...
         <span class="msg">The partner has been successfully added!</span>
         <div class="close-btn">
