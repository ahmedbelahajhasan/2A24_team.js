...
<body class="bg-brown">
    ...
    <div class ="container ">
        ...
        <button class =" bg-orange border-none rounded-full
             px-25 py-12 font-bold text-sm "><a href = "user.php" class="text-white no-underline"  >Ajouter une carte de fidélité</a> 
    ...
    if($result)
    {
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            echo '<tr>
                    ...
                    <td>
                        <button class="bg-orange border-none rounded-full
                        px-25 py-12 font-bold text-sm "><a href="update.php?updateid_carte='.$id_carte.'" class="text-white no-underline" ">Modifier</a></button>
                        <button class="bg-orange border-none rounded-full
                        px-25 py-12 font-bold text-sm "><a href="delete.php?deleteid_carte='.$id_carte.'" class="text-white no-underline"  >Supprimer</a></button>
                    </td>
