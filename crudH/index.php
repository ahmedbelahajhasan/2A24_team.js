  ...
  <div class="wrapper">
    ...
    <div class="nav">
      ...
      <div class="menu-links menu ul li:hover">
        <ul>
          <li ><a href="http://localhost:7070/crud/index.php" class ="no-underline textBlack">home</a></li>
          <li><a href="./jon/index.html"  class ="no-underline textBlack">Gestion des partenaires</a></li>
    ...
    <div class="watchnow ">
      ...
      <a href="http://localhost:7070/crud/index.php" class =" no-underline textBlack" >welcome</a>
    </div>
