<?php
    ...
    if(isset($_POST['update']))
    {
     ...
     {
      $sql = "update `crud` set  nom='$nom' , prenom='$prenom' , adresse='$adresse ',email='$email', description='$description' where id=$id";
        $result = mysqli_query ($con, $sql);
        if ($result)
        {
...
<html lang="en">
  ...
  <h1 class="px-76 py-26 font-lato" style="margin-left: 41px;" >Modifier le partenaire</h1>
        ...
        <form  method= "post" >
           ...
           <select name="description" multtiple="" style="margin-left: 14px;">
            ...
            <!--<div class="form-group  container-start width-input ">
                ...
                <input type="number"  class="form-control" placeholder="Entrer l'id contrat " name ="id_contrat" autocomplete = "off" 
                    style="margin-left: 122px;"value=>
            ...
            <button type="update"  style=" margin-left: 491px;
                " name= "update"  href= "display.php" >Modifier</button>

<div class="alert hide">
         <span class="fas fa-exclamation-circle"></span>
         <span class="msg">Le partenaire a été modifié avec succées!</span>
         <div class="close-btn">
