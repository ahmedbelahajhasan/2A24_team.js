                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           ...
                           <li class="nav-item ">
                                 <a class="nav-link" href="http://localhost:7070/crud/index.php"> Home  </a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="http://localhost:7070/crud/partenaire/display.php">Partenaire</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="http://localhost:7070/crud/contrat/display.php">Contrat </a>
                              </li>
                              <li class="nav-item active">
                                 <a class="nav-link" href="http://localhost:7070/crud/jon/index.php">Localisation</a>
                              </li>
