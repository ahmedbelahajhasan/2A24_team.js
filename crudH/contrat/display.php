...
<body class="bg-brown">
    ...
    <button class =" bg-orange border-none rounded-full
             px-25 py-12 font-bold text-sm "><a href = "user.php" class="text-white no-underline"  >Ajouter un contrat</a> 
        ...
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            echo '<tr>
                    ...
                    <td>
                        ...
                        <button class="bg-orange border-none rounded-full
                        px-25 py-12 font-bold text-sm "><a href="update.php?updateid_c='.$id_contrat.'" class="text-white no-underline" ">Modifier</a></button>
                        <button class="bg-orange border-none rounded-full
                        px-25 py-12 font-bold text-sm "><a href="delete.php?deleteid_c='.$id_contrat.'" class="text-white no-underline"  >Supprimer</a></button>
                    </td>
