...
<div class="container-fluid" style="background-color:choco">
  <div class="row">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add-product-form" enctype="multipart/form-data" name="add-product-form">
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Name</label>
		        		<input type="text" name="product_name" class="form-control" placeholder="Enter Product Name"id="product_name">
                <div id="err_product_name" style="color:red"></div>
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Keywords <small>(eg: bmw,4x4,berline)</small></label>
        		...
        		<div class="col-12">
        			<button type="submit" class="btn btn-primary add-product" onclick="verif()">Add Product</button>
        		</div>
        	</div>
...
function verif(){
  ...
  product_name=document.getElementById("product_name");
    ...
    Login_form=document.getElementById("add-product-form");
     err_product_name=document.getElementById("err_product_name")
     err_product_name.innerHTML=""
     
    
    Login_form.addEventListener("submit",function (e){
      var letters = /^[A-Za-z]+$/;
    if(!product_name.value.match(letters)&&product_name.value)
    {
      err_product_name.innerHTML=" name has to be letters!";
        e.preventDefault();
    }
