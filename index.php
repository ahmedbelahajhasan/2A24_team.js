...
<button class="nodeco botSender" onclick="botReply(this.value)" value="1" id="StoreLocator">Comment ajouter une question ? </button>
<button class="nodeco botSender" onclick="botReply(this.value)" value="2" id="Products">Comment ajouter une reponse ?</button>
<button class="nodeco botSender" onclick="botReply(this.value)" value="3" id="EventPublish">Comment modifier ou supprimer une question ou une reponse ?</button>
...
var text = document.createTextNode("Pour ajouter une question il suffit de cliquer sur ajouter une question et choisir un id non utilisé ");
message.appendChild(text);
...
var text = document.createTextNode("Pour ajouter un reponse il suffit de cliquer sur ajouter une reponse et mettre l'id de la question");
message.appendChild(text);
...
var text = document.createTextNode("Pour modifier ou supprimer une question ou une reponse il suffit de cliquer sur modifier question/reponse et sauvegarder les changements");
message.appendChild(text);
